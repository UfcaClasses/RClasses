...
model = BayesianNetwork([('hasKnowledgment', 'correctAnswer_Q01')])#arcs from the cause to the effect
 # Defining the CPDs:
#PRIORS
...
posterior_p = infer.query(['hasKnowledgment'], evidence={'correctAnswer_Q01': 'YES'})
print(posterior_p)
...
print(cpd_correctAnswer_Q02)
 # Associating the CPDs with the network structure.
model2.add_cpds(cpd_hasKnowledgment, cpd_correctAnswer_Q01, cpd_correctAnswer_Q02)
model2.check_model()
#BBN (for qualitative analysis)
#COMPUTING THE POSTERIOR/MARGINAL DISTRIBUTIONS
# from pgmpy.inference import VariableElimination
...
posterior_p2 = infer.query(['hasKnowledgment'], evidence={'correctAnswer_Q01': 'YES', 'correctAnswer_Q02': 'YES'})
print(posterior_p2)
