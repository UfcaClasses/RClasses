...
```{r setup}
ROOT = "/cloud/project/"#RStudio Cloud
# ROOT = "../R/"#local machine
# library(RClasses)
source(paste(ROOT, 'R/classicBoxPlot.R', sep=''))
source(paste(ROOT, 'R/distribFreq.R', sep=''))
source(paste(ROOT, 'R/mode_function.R', sep=''))
source(paste(ROOT, 'R/iqv_function.R', sep=''))
...
#dataPath = "./data/"#local machine
dataPath = "/cloud/project/data/"#RStudio Cloud
...
q = quantile(x = dados$TempoFalha, probs = c(.25, .75), na.rm = TRUE) # nolint
